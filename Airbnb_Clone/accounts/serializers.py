...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    password = serializers.CharField(write_only=True, required=True, validate=[validate_password], trim_whitespace=False)
...
class BaseOAuthLoginSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        user, created = User.objects.get_or_create(email=email,
            defaults={ "name": user_info.get("name", ""),'is_active': True, 'is_verified': True}
        )
